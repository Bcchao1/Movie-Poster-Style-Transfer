...
def get_args():
    ...
    parser.add_argument('--style', default=10, type=float,
                        help='Style weight')
    parser.add_argument('--content', default=25, type=float,
                        help='Content weight')
    parser.add_argument('--tv', default=1e-4, type=float,
                        help='TV weight')

    parser.add_argument('--styleim', default='d7.jpg', type=str,
                        help='Style image name')
    parser.add_argument('--loadstyle', default='d7_step_28', type=str,
                        help='Load pretrained style transfer model')
    parser.add_argument('--input_path', default='../data/originals/superhero/sh7.jpg', type=str,
                        help='test image path')
    parser.add_argument('--save_path', default='../data/sh7_d7.png', type=str,
